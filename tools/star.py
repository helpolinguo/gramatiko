...
gravure se moyenne au lieu de peser sur un point.
    ...
    python3 tools/star.py                  # la vignette composee
    python3 tools/star.py --scan           # le scan brut du feuillet 3
    python3 tools/star.py --essai 1.05     # ce que donnerait +1,05 deg
...
VIGNETTE = os.path.join(RACINE, 'ornaments', 'vignette-3.png')
FEUILLET = 3
