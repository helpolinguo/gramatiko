...
%  hyperref redefinit \parindent, \baselineskip et la mise en boite, et
%  ce volume a sa pagination gelee au dixieme de millimetre.
%  « goto page N » vise la page par son rang, sans ancre a poser dans le
%  texte. « count -n » ouvre une entree fermee portant n enfants.
%
%  LES APENDICI FORMENT LEUR PROPRE GROUPE, et non une queue de la
%  deuxieme partie. Un premier etat les y laissait, et donnait pour
%  entree « APENDICI » de premier niveau le TITRE DE RUBRIQUE DU TABELO
%  (folio 232) — la page ou le Tabelo les enumere, non les appendices
%  eux-memes : cliquer dessus menait a la table. Les dix sections des
%  folios 179 a 223 sont detachees et rangees sous un « APENDICI » qui
%  vise le premier d'entre eux. Le titre de rubrique du Tabelo est
%  retire : ce n'est pas une section du livre.
%
%  LE TABELO OUVRE AU FEUILLET 229, page 227 — non 226. Un premier etat
%  cherchait le feuillet en remontant depuis la premiere ligne
%  contenant « TABELO », qui est un COMMENTAIRE du fichier source.
%
%  Le texte des signets est reduit a l'ASCII, le catalogue PDF
%  n'acceptant que PDFDocEncoding ou l'UTF-16.
% ===================================================================
