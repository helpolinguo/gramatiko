...
% CENTRE sur la justification. Releve sur scan/r0224.png (bloc de texte
% x 41-1123, justification 1082 px) : l'encre du schema court de 490 a
% 665, soit 449 px a gauche (41,5 %) et 458 a droite (42,3 %) -- ecart
% 9 px sur 1082. Les abscisses ci-dessous le disent deja au composeur ;
% la marque le dit a la page de lecture, dont la colonne n'a pas la
% largeur du volume.
\VUtabloCentrita
\VUblanc{3.50mm}
...
% CENTRE lui aussi, et par la meme mesure : « Ludovikus » court de 490 a
% 673 (449 px a gauche, 450 a droite) et l'accolade horizontale de 311 a
% 849 (270 et 274). L'arbre est donc centre a un pixel pres sur 1082.
\VUtabloCentrita
