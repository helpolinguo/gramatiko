% ===================================================================
%  First part — MORFOLOGIO E SINTAXO
%  Leaf 15 = folio 11 (the folio is not printed on this page).
%
%  Measurements (tools/page.py, leaf 15):
%    title ALFABETO.      y = 459 px ; cap 2,540 mm ; width 18,54 mm
%                         -> 10,63 pt, letterspacing -19 (bold)
%    title PRONUNCO...    cap 2,455 mm ; width 41,99 mm
%                         -> 10,27 pt, letterspacing +8 (bold)
%    1st line of body     y = 548 px = 46,40 mm
%    title PRONUNCO...    y = 1005 px = 85,09 mm
%    note rule            y = 1550 px = 131,2 mm
% ===================================================================

% --- Leaf 15 (folio 11) ---------------------------------------------
\begin{VUpage}[15]{}
% The notes are placed at their measured ordinate; they take up no
% height and are therefore declared at the head of the page (cf. preamble).
\VUnotes{131.37mm}{%
...
\VUblancAlinea
% Whites measured at leaf 15: 114 px above the title, 89 px below
% (the set text gave 92 and 85). As at leaf 28, the whites that frame
% a title are measured, they are not deduced.
\VUsaut{5.26mm}
...
% --- Leaf 16 (folio 12) --------------------------------------------
%  Measurements: title PRONUNCO DIL KONSONANTI E DIGRAMI. at y = 1305 px,
%  cap 2,455 mm, width 72,81 mm -> 10,27 pt, letterspacing +9 (bold).
%  Note rule at y ~ 1830 px = 154,9 mm.
\begin{VUpage}[16]{12}
\VUnotes{156.38mm}{%
...
\VUblancAlinea
% Whites measured at leaf 16: 124 px above the title, 90 px below
% (the set text gave 78 and 87).
\VUsaut{6.49mm}
...
% --- Leaf 17 (folio 13) --------------------------------------------
%  Note rule at y ~ 1325 px = 112,2 mm.
%  Rule of enrichment: bold = the Ido letter as a headword;
%  italic = a letter, a sound or a word quoted from another language.
\begin{VUpage}[17]{13}
\VUnotes{113.23mm}{%
...
% --- Leaf 18 (folio 14) --------------------------------------------
%  Note rule at y ~ 1450 px = 122,8 mm.
\begin{VUpage}[18]{14}
\VUnotes{124.52mm}{%
...
% --- Leaf 19 (folio 15) --------------------------------------------
%  Note rule: 1412 px on the scan, 188 px for the 1st line of body,
%  that is 24,30 + (1412-188) x 25,4/300 = 127,97 mm. Measure the
%  ordinate RELATIVE to the 1st line, never on the raw y of the scan.
%  Title ACENTO TONIKA. : cap 2,540 mm, width 29,13 mm
%                         -> 10,63 pt, letterspacing -34 (bold).
%  Small capitals in the notes (proper names).
\begin{VUpage}[19]{15}
\VUnotes{130.00mm}{%
...
% Whites MEASURED on the baselines (tools/baselines.py):
%   running pitch 41,19 px ; before the title 123,7 px, after 95,0 px,
%   that is 6,98 mm and 4,56 mm to be added to the pitch.
\VUsaut{6.98mm}
...
% --- Leaf 20 (folio 16) --------------------------------------------
%  Note rule: ordinate 107,95 mm (tools/rule.py).
\begin{VUpage}[20]{16}
\VUnotes{108.07mm}{%
...
% --- Leaf 21 (folio 17) --------------------------------------------
%  Note rule: ordinate 125,14 mm (tools/rule.py).
\begin{VUpage}[21]{17}
\VUnotes{124.79mm}{%
...
% --- Leaf 22 (folio 18) --------------------------------------------
%  Note rule at y = 896 px. Ordinate computed FROM THE FOLIO (y=116),
%  whose set position is fixed, and not from \VUmargeSup: this page
%  opens with a title, so its 1st line of body is not at the usual
%  margin. 18,71 + (896-116) x 25,4/300 = 84,75 mm.
%  Wrongly computed from \VUmargeSup it gave 71,63 mm, and the block
%  of notes rose into the running text.
%  Title ARTIKLO. : cap 2,455 mm, width 15,66 mm
%  -> 10,27 pt, letterspacing -17 (bold).
%  The 1st note continues that of folio 17.
\begin{VUpage}[22]{18}
\VUnotes{84.75mm}{%
...
% Ordinates measured RELATIVE TO THE FOLIO, whose set position is fixed
% (\VUfolioY = 18,71 mm). On the scan: folio y=116, title y=243, 1st line
% of body y=337. So the title at 18,71 + 127x25,4/300 = 29,46 mm, the
% body at 18,71 + 221x25,4/300 = 37,42 mm.
% Measuring from the edge of the IMAGE gave 20,57 mm for the title, which
% then came to overlap the folio: each image of the scan has its own
% vertical offset.
\VUsaut{5.16mm}
...
% A line almost entirely bold: it overruns the measure slightly.
% We tighten it, as the compositor does, rather than let TeX break it
% again (cf. \VUserre in the preamble).
...
% --- Leaf 23 (folio 19) --------------------------------------------
%  Note rule: ordinate 144,36 mm (tools/rule.py).
%  A first OCR pass used as a draft, then checked and enriched by eye.
\begin{VUpage}[23]{19}
\VUnotes{144.36mm}{%
...
% --- Leaf 24 (folio 20) --------------------------------------------
%  Note rule at y = 1813 px, folio at y = 146 px
%  -> 18,71 + (1813-146) x 25,4/300 = 159,85 mm.
%  A page continuing folio 19: the 1st paragraph resumes flush left.
\begin{VUpage}[24]{20}
\VUnotes{159.85mm}{%
...
% --- Leaf 25 (folio 21) --------------------------------------------
%  Note rule at y = 1086 px, folio at y = 147 px
%  -> 18,71 + (1086-147) x 25,4/300 = 98,21 mm.
%  Title SUBSTANTIVO. : cap 2,455 mm, width 24,05 mm
%  -> 10,27 pt, letterspacing -27 (bold).
%  Note (1) runs on to folio 22: its last line is full.
\begin{VUpage}[25]{21}
\VUnotes{98.21mm}{%
...
\VUblancAlinea
% An indented paragraph (x0 = 56 px surveyed) and not a continuation of
% the previous folio: a third \VUcontinue too many, this one found by
% check 10.
...
% --- Leaf 26 (folio 22) --------------------------------------------
%  The folio (y = 165) escapes the detector on this page: it is pale.
%  Ordinates recomputed from its position surveyed by hand:
%    body   : 18,71 + (246-165) x 25,4/300 = 25,57 mm -> jump 1,27 mm
%    rule   : 18,71 + (1521-165) x 25,4/300 = 133,52 mm
%  The block of notes opens with the end of note (1) of folio 21.
\begin{VUpage}[26]{22}
\VUnotes{133.90mm}{%
...
% An enumeration: each entry is a PARAGRAPH in its own right. It
% therefore carries the indent (measured: +4,5 mm from the margin, that
% is \VUalinea) and its last line stays short. Chained by an explicit
% break, these lines lost their indent AND were justified by force: the
% facsimile
% gives them at 29, 32, 45, 48, 56, 59, 63, 68 and 75 % of the measure.
% +36,7 px surveyed before this paragraph (tools/carding.py). The next
% entry being a paragraph on its own, the automatic layer finds no
% ordinary boundary to write it at: laid by hand.
\VUblanc{8.84pt}
...
% --- Leaf 27 (folio 23) --------------------------------------------
%  Note rule at y = 1566 px, folio at y = 144 px
...
% --- Leaf 28 (folio 24) --------------------------------------------
%  Note rule at y = 1587 px, folio at y = 146 px
%  -> 18,71 + (1587-146) x 25,4/300 = 140,73 mm.
%  Title PROPRA NOMI. : cap 2,455 mm, width 25,06 mm
%  -> 10,27 pt, letterspacing -18 (bold).
\begin{VUpage}[28]{24}
\VUnotes{138.92mm}{%
...
% A running title is not an ordinary paragraph boundary: the whites
% that frame it are measured, they are not deduced. Discrepancies
% surveyed at leaf 28: 52 px above the title, 81 px below, for a
% regular pitch of 41,43 px.
\VUsaut{1.00mm}
...
% --- Leaf 29 (folio 25) --------------------------------------------
%  Note rule at y = 1681 px, folio at y = 122 px
...
% --- Leaf 30 (folio 26) --------------------------------------------
%  Note rule at y = 1624 px, folio at y = 149 px -> 143,59 mm.
%  This is the page that served for the initial calibration of the type
%  size (§ 4.2 of docs/journal.md): its lines 1 to 6 are partly BOLD,
%  which had falsified that calibration. Here it is, surveyed for good.
\begin{VUpage}[30]{26}
\VUnotes{141.87mm}{%
...
% --- Leaf 31 (folio 27) --------------------------------------------
%  Note rule at y = 1491 px, folio at y = 117 px -> 135,04 mm.
%  Title ADJEKTIVO QUALIFIKANTA. : cap 2,455 mm, width 47,58 mm
%  -> 10,27 pt, letterspacing +2 (bold).
\begin{VUpage}[31]{27}
\VUnotes{132.87mm}{%
...
% --- Leaf 32 (folio 28) --------------------------------------------
%  Note rule at y = 1414 px, folio at y = 135 px -> 127,00 mm.
%  The block of notes opens with the end of note (3) of folio 27.
\begin{VUpage}[32]{28}
\VUnotes{127.00mm}{%
...
% --- Leaf 33 (folio 29) --------------------------------------------
%  A page with very long notes: 10 lines of body, 38 of notes.
%  The rule detector fails here (the rule is high in the page and the
%  column of notes follows it very closely). Surveyed by hand: y = 610.
...
% --- Leaf 34 (folio 30) --------------------------------------------
%  The rule detector fails again (the notes press close to it):
%  surveyed by hand, first dark row y = 1419, folio y = 118.
%  -> 18,71 + (1419-118) x 25,4/300 = 128,86 mm ; corrected to 129,94 mm,
%  the hand survey of the rule (a threshold and a closing different from
%  those of tools/rule.py) falling 1,08 mm too high. The discrepancy was
%  found by check 11: the block of notes was 12,7 px above the model.
%  This page revealed a fault in the analysis of the facsimile: the
%  flecks of the neighbouring leaf's fore-edge, 40 px from the last
%  character, were being welded to the lines. Fixed in tools/page.py
%  (bounding the column by density BEFORE the weld).
\begin{VUpage}[34]{30}
\VUnotes{129.92mm}{%
...
% Carded page. Pitch measured over the 16 regular pitches of the body
% (tools/baselines.py): 43,10 px instead of the usual 41,45, that is
% 43,10 x 72,27/300 = 10,38 pt. The \VUblanc below are the EXCESS of
% the surveyed pitch over those 43,10 px.
...
% --- Leaf 35 (folio 31) --------------------------------------------
%  THE VOLUME'S FIRST TABLE. Survey: tools/page.py + measurements of the
%  abscissae by hand (see docs/journal.md, § 7 ter).
%  Baselines of the table: 413, 454, 495 px for the « Komparativo »
%  group, 561, 602,5, 643,5 px for the « Superlativo » group.
%  The pitch there is 41 px: the table is on the volume's grid.
%  « Superlativo » and « de o ek » fall HALFWAY between two lines; they
%  are laid with \VUdecale.
%  Weight: the column of quoted forms (plu, tam, min, kam, maxim,
%  minim, tre) is in bold; the names of the degrees (Supereso, egaleso,
%  infreso, relatanta, absoluta) and « de o ek » are in roman. Checked
%  under magnification at x3 (scan/T35c.png, T35d.png).
\begin{VUpage}[35]{31}
% Ordinate of the block of notes. The surveyed rule gives 102,95 mm;
% comparing the set and the surveyed lines of note (check 11 cannot do
% it here, the facsimile's division of the table into lines not
% agreeing) asks for 1,27 mm more.
\VUnotes{104.22mm}{%
...
% The note runs on to the next folio: its last line therefore runs to
% the margin (1081 px surveyed for a measure of 1083).
\parplein
}
\VUsaut{5.2mm}
...
% Braces of the table. Extents surveyed on the facsimile (threshold 180,
% narrow windows around each stroke):
%   1. « Komparativo » : y 382..498, centre 440, height 116 px = 27,9 pt.
%      It runs from Supereso to infreso by way of egaleso; its point is
%      on the middle row.
%   2. « relatanta / absoluta » : rows B and C of the second group,
%      centre 607,5, height 72 px = 17,4 pt. Very pale on the scan.
%   3. « Supereso / infreso » : y 531..596, centre 566, height 65 px.
%   4. « maxim / minim » : y 543..612, centre 577,5, height 69 px.
%      This one is a CLOSING brace: it points at « de o ek », on the
%      right. Its centre falls on the baseline of « de o ek » (581).
% Baselines: 413, 454, 495 (group 1) ; 561, 602,5, 643,5 (group 2).
\VUrang{%
\VUcase{4.91mm}{28.}%
...
\VUblanc{6.02pt}% +25 px between the table's two groups
\VUrang{%
...
% « Superlativo » falls halfway between this row and the next. It is
% attached to THIS one, lowered by the surveyed amount, and not to the
% next raised by as much: the set position is the same, but this is how
% pdftotext groups it, and check 2 can therefore compare it.
\VUrang{%
...
\VUblanc{9.88pt}% one blank line between the table and the text
...
% --- Leaf 36 (folio 32) --------------------------------------------
%  Note rule surveyed by hand (the detector fails): y = 833,
%  folio y = 118 -> 18,71 + (833-118) x 25,4/300 = 79,25 mm.
%  The volume's second table, simpler than that of folio 31: no brace,
%  four rows on the grid (baselines 434, 477, 518,6 and 560 px, regular
%  pitch 41,6). Abscissae surveyed one by one.
%  Carding: an excess of 22,4 px above the table and of 22,7 px below,
%  measured by tools/carding.py.
\begin{VUpage}[36]{32}
\VUnotes{77.68mm}{%
% This note continues that of folio 31: its first line starts from the
% margin (x0 = 1 px surveyed, against 43 for the start of a paragraph
% of note).
...
% The note runs on to the next folio: last line justified.
\parplein
}
\VUsaut{5.2mm}
...
\VUblanc{3.54pt}% +22,4 px above the table
\VUrang{%
...
\VUblanc{3.61pt}% +22,7 px below the table
...
% --- Leaf 37 (folio 33) --------------------------------------------
%  Rule surveyed by hand: y = 1287, folio y = 129
%  -> 18,71 + (1287-129) x 25,4/300 = 116,75 mm.
%  MIND: the facsimile's division into lines WELDS two lines of note
%  here, « ... vice la simpla » and « lua, lia. » (band 1650-1714): the
%  second is short, entirely in italic, and its descenders mingle with
%  those of the first. The facsimile therefore counts 41 lines and not
%  40. The survey below takes account of it; checks 9 and 11 will skip
%  the page and say so.
\begin{VUpage}[37]{33}
\VUsignature{168.74mm}{2}% signature de cahier
\VUnotes{116.75mm}{%
% This note continues that of folio 32: first line at the margin.
...
% --- Leaf 38 (folio 34) --------------------------------------------
%  Rule surveyed by hand: y = 1264, folio y = 135
%  -> 18,71 + (1264-135) x 25,4/300 = 114,30 mm.
%  The list of possessive adjectives (lines 5 to 18) is made of short
%  paragraphs, all at the indent (x0 = 51 px surveyed), none justified:
%  each is therefore a paragraph on its own, like the enumeration of
%  folio 22.
\begin{VUpage}[38]{34}
\VUnotes{112.70mm}{%
...
% --- Leaf 39 (folio 35) --------------------------------------------
%  Rule surveyed by hand: y = 1127, folio y = 137
...
% These two lines look bold in an overall view -- it is the ink
% spreading. Check 9 gave -24 % and -17 % (the set text more loaded
% than the model), and the enlargement at x 1,9 confirms it: they are
% in roman.
...
% --- Leaf 40 (folio 36) --------------------------------------------
%  Rule surveyed by hand: y = 1344, folio y = 120
%  -> 18,71 + (1344-120) x 25,4/300 = 122,34 mm.
%  As at leaf 37, the detector misses the last line of note
%  (« XI, 296.) », short and pale: its projection peaks at 68 when the
%  page's threshold is higher). The facsimile counts 38 lines, the
%  survey gives 38; checks 9 and 11 will skip the page.
%  Whites of the title: 132,0 px above, 99,2 px below (measured on the
%  baselines, tools/baselines.py).
\begin{VUpage}[40]{36}
\VUnotes{121.53mm}{%
...
% --- Leaf 41 (folio 37) --------------------------------------------
%  Rule surveyed by hand: y = 1035, folio y = 134
%  -> 18,71 + (1035-134) x 25,4/300 = 94,99 mm.
%  Two short lines -- « misas. » and « ici, iti. » -- fell under the
%  threshold of detection; the recovery of pale lines finds them again,
%  and the facsimile is duly surveyed at 43 lines.
\begin{VUpage}[41]{37}
\VUnotes{93.78mm}{%
...
% --- Leaf 42 (folio 38) --------------------------------------------
%  Rule surveyed by hand: y = 1208, folio y = 134
%  -> 18,71 + (1208-134) x 25,4/300 = 109,64 mm.
%  The folio of this page comes down to its two figures: the ems that
%  frame it are flat and wide, and so rejected at the glyph mask, and
%  « 38 » welded is only 60 px. The fallback folio mask of folio_ligne
%  was needed to find it again.
%  Whites of the title: 123,0 px above, 102,4 px below.
\begin{VUpage}[42]{38}
\VUnotes{108.46mm}{%
% This note continues that of folio 37: first line at the margin.
...
% --- Leaf 43 (folio 39) --------------------------------------------
%  Rule surveyed by hand: y = 1711, folio y = 147
%  -> 18,71 + (1711-147) x 25,4/300 = 151,13 mm.
%  Whites of the title: 123,4 px above, 94,4 px below.
\begin{VUpage}[43]{39}
\VUnotes{150.03mm}{%
...
% --- Leaf 44 (folio 40) --------------------------------------------
%  Rule surveyed by hand: y = 1631, folio y = 142
%  -> 18,71 + (1631-142) x 25,4/300 = 144,78 mm.
%  Whites of the title: 148,0 px above, 99,3 px below.
\begin{VUpage}[44]{40}
\VUnotes{144.27mm}{%
...
% The note runs on to the next folio: last line justified
% (1082 px surveyed for a measure of 1083).
\parplein
}
...
% --- Leaf 45 (folio 41) --------------------------------------------
%  Rule surveyed by hand: y = 1174, folio y = 141
%  -> 18,71 + (1174-141) x 25,4/300 = 106,17 mm.
%  A page with an ordinary paragraph white: seven boundaries at
%  7,4-9,1 px.
\begin{VUpage}[45]{41}
\VUnotes{104.48mm}{%
% This note continues that of folio 40: first line at the margin.
...
% --- Leaf 46 (folio 42) --------------------------------------------
%  Rule surveyed by hand: y = 1334, folio y = 142
%  -> 18,71 + (1334-142) x 25,4/300 = 119,63 mm.
%  MIND: the line « en -u. » (y ~ 1003, 90 px wide) falls under the
%  threshold and under the ink criterion of the recovery (0,07 against
%  the 0,12 required). The facsimile counts 41 lines, the detector sees
%  only 40: the same limit as at leaf 37. The survey below gives them
%  all; checks 9 and 11 will skip the page.
\begin{VUpage}[46]{42}
\VUnotes{119.63mm}{%
...
% --- Leaf 47 (folio 43) --------------------------------------------
%  Rule surveyed by hand: y = 1054, folio y = 145
...
% --- Leaf 48 (folio 44) --------------------------------------------
%  Rule surveyed by hand: y = 1289, folio y = 153
%  -> 18,71 + (1289-153) x 25,4/300 = 114,88 mm.
%  The folio of this page is crossed by a fold in the paper: the
%  diagonal stroke carried the extent of its band to 396 px, centred at
%  0,703, and folio_ligne rejected it as too wide. The detector now
%  examines the CLUSTERS of the band, not its total extent.
\begin{VUpage}[48]{44}
\VUnotes{114.88mm}{%
...
% --- Leaf 49 (folio 45) --------------------------------------------
%  Rule surveyed by hand: y = 1680, folio y = 154 -> 147.91 mm.
\begin{VUpage}[49]{45}
\VUnotes{149.78mm}{%
...
% This line is a paragraph on its own: the facsimile indents it by
% 49 px, that is the ordinary indent. It is not the continuation of
% the paragraph of the previous folio.
...
% --- Leaf 50 (folio 46) --------------------------------------------
%  Rule surveyed by hand: y = 940, folio y = 149 -> 85.68 mm.
\begin{VUpage}[50]{46}
\VUnotes{90.64mm}{%
...
% --- Leaf 51 (folio 47) --------------------------------------------
%  Rule surveyed by hand: y = 906, folio y = 136 -> 83.90 mm.
\begin{VUpage}[51]{47}
\VUnotes{82.01mm}{%
...
% --- Leaf 52 (folio 48) --------------------------------------------
%  Rule surveyed by hand: y = 1121, folio y = 130 -> 102.61 mm.
\begin{VUpage}[52]{48}
\VUnotes{101.49mm}{%
...
% --- Leaf 53 (folio 49) --------------------------------------------
%  Rule surveyed by hand: y = 763, folio y = 124 -> 72.81 mm.
%  The line « tita. » (short) falls under the threshold: the facsimile
%  counts 45 lines, the detector 44. The same limit as at leaves 37
%  and 46.
\begin{VUpage}[53]{49}
\VUnotes{72.81mm}{%
...
% --- Leaf 54 (folio 50) --------------------------------------------
%  Rule surveyed by hand: y = 1272, folio y = 135 -> 114.98 mm.
%  The eight forms of § 44 are aligned on two surveyed indents:
%  119-122 px for those without « me », 47-48 px for the others.
\begin{VUpage}[54]{50}
\VUnotes{112.54mm}{%
...
% --- Leaf 55 (folio 51) --------------------------------------------
%  Rule surveyed by hand: y = 1642, folio y = 145 -> 145.46 mm.
\begin{VUpage}[55]{51}
\VUnotes{143.94mm}{%
...
% These three lines are in roman, EXCEPT the two runs of quoted verbs,
% which are in bold -- the volume's rule of enrichment.
% The density of ink did not decide here (everything between 7,3 and
% 8,9); the THICKNESS OF THE STEMS does, and clearly: « frapar, donar,
% lektar » measure 4,0 px where « quale en la transitivi » and « ma en
% li » measure 3,0. See tools/weight.py.
...
% --- Leaf 56 (folio 52) --------------------------------------------
%  Rule surveyed by hand: y = 1611, folio y = 148 -> 142.58 mm.
\begin{VUpage}[56]{52}
\VUnotes{143.12mm}{%
...
% --- Leaf 57 (folio 53) --------------------------------------------
%  Rule surveyed by hand: y = 1112, folio y = 141 -> 100.92 mm.
\begin{VUpage}[57]{53}
\VUnotes{99.33mm}{%
...
% --- Leaf 58 (folio 54) --------------------------------------------
%  Rule surveyed by hand: y = 1621, folio y = 159 -> 142.49 mm.
\begin{VUpage}[58]{54}
\VUnotes{141.48mm}{%
...
% --- Leaf 59 (folio 55) --------------------------------------------
%  Rule surveyed by hand: y = 1587, folio y = 144 -> 140.88 mm.
\begin{VUpage}[59]{55}
\VUnotes{141.13mm}{%
...
% This line is an indented paragraph (x0 = 58 px surveyed, against
% 54 px for the ordinary indent), not the continuation of the previous
% folio.
...
% --- Leaf 60 (folio 56) --------------------------------------------
%  Rule surveyed by hand: y = 1739, folio y = 121 -> 155.70 mm.
%  Whites of the title measured BEFORE composition (the lesson of folio
%  46): 136,0 px above, 108,1 px below.
%  The last line of note (« elu (v. § 52). ») falls under the
%  threshold: 35 lines in the facsimile, 34 at the detector.
\begin{VUpage}[60]{56}
\VUnotes{155.70mm}{%
...
% --- Leaf 61 (folio 57) --------------------------------------------
%  Rule surveyed by hand: y = 1152, folio y = 154 -> 103.21 mm.
%  The line of note « utileso. » falls under the threshold: 43 lines in
%  the facsimile, 42 at the detector.
\begin{VUpage}[61]{57}
\VUnotes{103.21mm}{%
...
% -------------------------------------------------------------------
%  leaf 62 -- folio 58: 17 lines of body, 25 of note.
%  Regular pitch 41,42 px: the page is not carded, and NONE of its
%  sixteen paragraph boundaries carries a white (the largest pitch of
%  the body is 42,9 px, 1,5 px above the running pitch).
% -------------------------------------------------------------------
\begin{VUpage}[62]{58}
\VUnotes{90.65mm}{%
...
% -------------------------------------------------------------------
%  leaf 63 -- folio 59: 23 lines of body, 19 of note.
%  One white of articulation only, before « 53. --- » (excess 21,6 px).
% -------------------------------------------------------------------
\begin{VUpage}[63]{59}
\VUnotes{107.79mm}{%
...
% -------------------------------------------------------------------
%  leaf 64 -- folio 60: 26 lines of body, 15 of note.
%  A dense page: none of its sixteen paragraph boundaries carries a
%  white (the largest pitch of the body is 43,2 px, 1,9 px too much).
% -------------------------------------------------------------------
\begin{VUpage}[64]{60}
\VUnotes{119.18mm}{%
...
% -------------------------------------------------------------------
%  leaf 65 -- folio 61: 16 lines of body, 27 of note.
%  The note rule escapes tools/rule.py (it finds it, but its safeguard
%  « nothing else on the line » rejects it): surveyed by hand at
%  y = 926 px, whence 24,30 + (926-210) x 25,4/300 = 84,92 mm.
%  The enumeration « ultempe... irgekande » has NO white between its
%  items; the ordinary paragraph white remains before lines 3, 4 and
%  13 only.
% -------------------------------------------------------------------
\begin{VUpage}[65]{61}
\VUnotes{84.92mm}{%
...
% -------------------------------------------------------------------
%  leaf 66 -- folio 62: 26 lines of body, 13 of note.
%  The page OPENS on the continuation of the paragraph of folio 61:
%  \VUcontinue.
%  A white of articulation before « 54. --- » (excess 37,0 px).
% -------------------------------------------------------------------
\begin{VUpage}[66]{62}
\VUnotes{124.37mm}{%
...
% -------------------------------------------------------------------
%  leaf 67 -- folio 63: 22 lines of body, 16 of note.
%  A white of articulation before « 55. --- » (excess 36,8 px) and
%  before the line that follows it (12,2 px).
%  A TYPO OF THE ORIGINAL, kept: note (3) opens with « Me pagis a lu
%  cirkume dek franki »: the opening quotation mark is missing.
% -------------------------------------------------------------------
\begin{VUpage}[67]{63}
\VUnotes{113.90mm}{%
...
% -------------------------------------------------------------------
%  leaf 68 -- folio 64: 21 lines of body, 20 of note.
%  The page opens on the continuation of the paragraph of folio 63:
%  \VUcontinue.
% -------------------------------------------------------------------
\begin{VUpage}[68]{64}
\VUnotes{102.79mm}{%
...
% -------------------------------------------------------------------
%  leaf 69 -- folio 65: 9 lines of body, 34 of note.
%  The detector finds only 33: the line « homi. » (italic, two
%  syllables, very little ink) escapes it, as at leaves 37, 46, 53,
%  57, 60 and 61. It is set by hand here; checks 9 and 11 will skip
%  the page, the counts differing by one.
%  Rule surveyed by hand at y = 638 px: 24,30 + (638-225) x 25,4/300.
% -------------------------------------------------------------------
\begin{VUpage}[69]{65}
...
% -------------------------------------------------------------------
%  leaf 70 -- folio 66: 27 lines of body, 13 of note.
%  A white of articulation before « 55. --- » (excess 24,3 px).
%  A NUMBER REPEATED IN THE ORIGINAL: this « 55. » is the second --
%  folio 63 already carries one. Kept as it stands (§ 9).
% -------------------------------------------------------------------
\begin{VUpage}[70]{66}
\VUnotes{124.78mm}{%
...
% -------------------------------------------------------------------
%  leaf 71 -- folio 67: 22 lines of body (one of them a TITLE), 17 of
%  note. The page opens on the continuation of the paragraph of folio 66.
%  Whites of the title MEASURED on the baselines, before composition:
%  running pitch 41,46 px ; 123,3 px before the title, 90,4 px after,
%  that is 81,8 px (6,92 mm) and 48,9 px (4,14 mm) to be added to the
%  pitch.
%  Size and letterspacing: tools/apparatus.py 71 --regle PREPOZICIONI. 13
%  --gras -> capital 30 px = 2,54 mm -> 10,63 pt, letterspacing -45.
% -------------------------------------------------------------------
\begin{VUpage}[71]{67}
\VUnotes{113.74mm}{%
...
% -------------------------------------------------------------------
%  leaf 72 -- folio 68: 32 lines of body, 6 of note.
%  Whites of articulation before « 58. --- » (24,2 px) and « 59. --- »
%  (24,6 px).
%  A TYPO OF THE ORIGINAL, kept: note (1), « dicernebla.Ol » -- the
%  full stop is not followed by a space.
% -------------------------------------------------------------------
\begin{VUpage}[72]{68}
\VUnotes{144.44mm}{%
...
% -------------------------------------------------------------------
%  leaf 73 -- folio 69: 14 lines of body, 30 of note.
%  The page opens on the continuation of the paragraph of folio 68.
%  A white of articulation before « 60. --- » (excess 25,3 px).
%  Rule surveyed by hand at y = 859 px: 24,30 + (859-226) x 25,4/300.
% -------------------------------------------------------------------
\begin{VUpage}[73]{69}
\VUnotes{77.19mm}{%
...
% -------------------------------------------------------------------
%  leaf 74 -- folio 70: 14 lines of body, 29 of note.
%  The page opens on the continuation of the paragraph of folio 69.
%  Rule surveyed by hand at y = 879 px: 24,30 + (879-227) x 25,4/300.
%  Note (2) itself carries a reference « * » and its sub-note.
% -------------------------------------------------------------------
\begin{VUpage}[74]{70}
\VUnotes{79.50mm}{%
...
% -------------------------------------------------------------------
%  leaf 75 -- folio 71: 37 lines of body, NO note.
%  tools/rule.py finds no rule, and here that is the right answer: the
%  page carries none. Its thirty-six pitches all lie between 39 and
%  42 px, without the short pitch peculiar to a block of notes.
% -------------------------------------------------------------------
\begin{VUpage}[75]{71}
\VUcontinue
...
% -------------------------------------------------------------------
%  leaf 76 -- folio 72: 32 lines of body, 7 of note.
%  The page opens on the continuation of the paragraph of folio 71.
%  None of its eleven paragraph boundaries carries a white.
% -------------------------------------------------------------------
\begin{VUpage}[76]{72}
\VUnotes{141.31mm}{%
...
% -------------------------------------------------------------------
%  leaf 77 -- folio 73: 23 lines of body, 18 of note.
%  The page opens on the continuation of the paragraph of folio 72.
%  A white of articulation before « 68. --- » (excess 23,9 px).
%  Note (2) runs on to folio 74 (it takes four lines there before
%  note (1) of that page).
% -------------------------------------------------------------------
\begin{VUpage}[77]{73}
\VUnotes{110.24mm}{%
...
% -------------------------------------------------------------------
%  leaf 78 -- folio 74: 33 lines of body, 6 of note.
%  The block of notes OPENS on the end of note (2) of folio 73: four
%  lines with no indent, before its own note (1).
%  Whites of articulation before « 69. --- » (15,4 px) and
%  « 70. --- » (16,0 px).
% -------------------------------------------------------------------
\begin{VUpage}[78]{74}
\VUnotes{144.14mm}{%
...
% -------------------------------------------------------------------
%  leaf 79 -- folio 75: 39 lines of body, NO note.
%  A white of articulation before « 71. --- » (excess 26,4 px).
% -------------------------------------------------------------------
\begin{VUpage}[79]{75}
...
% -------------------------------------------------------------------
%  leaf 80 -- folio 76: 28 lines of body, 9 of note.
%  ONE LINE ESCAPES THE DETECTOR: « kazo. », two syllables at the foot
%  of a paragraph. It falls IN THE BODY, and not in the notes as at
%  folio 65: the indices of all the following boundaries slip by one,
%  and poser_cardage cannot serve here. The four whites are therefore
%  computed by hand on the baselines, the missing line restored at its
%  pitch:
%     before « 72. » 105,9-41,5-41,5 = 23,9 px ; before « 73. » 27,9 px ;
%     before « 74. » 23,7 px ; before « 75. » 28,6 px.
% -------------------------------------------------------------------
\begin{VUpage}[80]{76}
\VUnotes{134.28mm}{%
...
% -------------------------------------------------------------------
%  leaf 81 -- folio 77: 31 lines of body, 7 of note.
%  The page opens on the continuation of the paragraph of folio 76.
% -------------------------------------------------------------------
\begin{VUpage}[81]{77}
\VUnotes{140.97mm}{%
...
% -------------------------------------------------------------------
%  leaf 82 -- folio 78: 26 lines of body, 14 of note.
%  The page opens on the continuation of the paragraph of folio 77.
%  Note (3) runs on to folio 79.
% -------------------------------------------------------------------
\begin{VUpage}[82]{78}
\VUnotes{121.24mm}{%
...
% -------------------------------------------------------------------
%  leaf 83 -- folio 79: 30 lines of body, 9 of note.
%  The block of notes OPENS on the end of note (3) of folio 78: four
...
% -------------------------------------------------------------------
%  leaf 84 -- folio 80: 32 lines of body, 5 of note.
%  ONE LINE ESCAPES THE DETECTOR: « yare. », in the body. The whites
%  are therefore computed by hand on the baselines, the missing line
%  restored at its pitch; the boundary that follows it carries NONE.
%     before « 84. » 24,2 px ; before « 85. » 23,7 px ;
%     before « 86. » 24,7 px ; before « 87. » 23,1 px.
%  The right edge of the leaf carries the shadow of a fold: the
%  surveyed widths of lines 11, 12 and 14 are inflated by it and are
%  worth nothing.
% -------------------------------------------------------------------
\begin{VUpage}[84]{80}
\VUnotes{146.47mm}{%
...
% -------------------------------------------------------------------
%  leaf 85 -- folio 81: 33 lines of body, 3 of note.
%  ONE LINE ESCAPES THE DETECTOR: « longa. », in the body. Whites
%  computed by hand on the baselines:
%     before « 88. » 23,0 px ; before « 89. » 23,0 px ;
%     before « 90. » 23,3 px ; before « 91. » 23,5 px.
% -------------------------------------------------------------------
\begin{VUpage}[85]{81}
\VUnotes{150.62mm}{%
...
% -------------------------------------------------------------------
%  leaf 86 -- folio 82: 33 lines of body, 3 of note.
%  A LAST LINE NOT DETECTED: « pos til. », which ends note (2).
%  Reported by tools/missing_lines.py (868 px of ink below the last
%  line detected, against 4 to 65 px on sound leaves).
%  It is the LAST of the page: no boundary of the body follows it, so
%  poser_cardage stays safe.
% -------------------------------------------------------------------
\begin{VUpage}[86]{82}
\VUnotes{151.98mm}{%
...
% -------------------------------------------------------------------
%  leaf 87 -- folio 83: 22 lines of body, 18 of note.
%  The page opens on the continuation of the paragraph of folio 82.
%  The detector welds the last line of note (« VI, 481. ») to the
%  descenders of the one before it: its surveyed width (1081 px) is
%  worth nothing, but the COUNT of the lines is right.
% -------------------------------------------------------------------
\begin{VUpage}[87]{83}
\VUnotes{110.00mm}{%
...
% -------------------------------------------------------------------
%  leaf 88 -- folio 84: 30 lines of body, 11 of note.
%  The page opens on the continuation of the paragraph of folio 83.
%  Its whites of articulation are narrower than elsewhere (11 to 16 px
%  against 23 to 28): the page is dense, the compositor tightened.
% -------------------------------------------------------------------
\begin{VUpage}[88]{84}
\VUnotes{134.44mm}{%
...
% -------------------------------------------------------------------
%  leaf 89 -- folio 85: 27 lines of body, 13 of note.
% -------------------------------------------------------------------
\begin{VUpage}[89]{85}
\VUnotes{124.12mm}{%
...
% -------------------------------------------------------------------
%  leaf 90 -- folio 86: 34 lines of body, 2 of note.
%  A LINE NOT DETECTED: « tismo. », in the body, reported by
%  tools/missing_lines.py (a pitch of 114,8 px for a local pitch of
%  41,4: not a white of 73,4 px, but a missing line followed by a
%  white of 32,1 px). Checked under magnification.
%  The two whites are therefore laid by hand, the line restored at its
%  pitch: before « 103. » 32,2 px ; before « 104. » 32,4 px.
% -------------------------------------------------------------------
\begin{VUpage}[90]{86}
\VUnotes{153.25mm}{%
...
% -------------------------------------------------------------------
%  leaf 91 -- folio 87: 34 lines of body, 4 of note.
%  A LINE NOT DETECTED: « pro li. », in the body, reported by
%  tools/missing_lines.py with the surest verdict it gives --
%  « a clean double, no white »: 82,8 px for a local pitch of 41,5.
%  The boundary that follows it therefore carries NO white, and the
%  page's only one (23,1 px, before « 106. ») is laid by hand.
% -------------------------------------------------------------------
\begin{VUpage}[91]{87}
\VUnotes{148.84mm}{%
...
% -------------------------------------------------------------------
%  leaf 92 -- folio 88: 31 lines of body (one of them a TITLE), 5 of note.
%  The page opens on the continuation of the paragraph of folio 87.
%  A LINE NOT DETECTED: « sur...). », in the body. Reported by
%  tools/missing_lines.py (a pitch of 83,1 px for a local pitch of
%  41,3) and checked against the facsimile. The boundary that follows
%  it carries no white: 83,1 - 2 x 41,3 = 0,5 px.
%  Whites of the title MEASURED on the baselines BEFORE composition:
%  114,9 px above (excess 73,6 = 6,23 mm), 90,5 px below
%  (excess 49,2 = 4,17 mm).
%  Size and letterspacing: tools/apparatus.py 92 --regle KONJUNCIONI. 20
%  --gras -> capital 29 px = 2,455 mm -> 10,27 pt, letterspacing -43.
% -------------------------------------------------------------------
\begin{VUpage}[92]{88}
\VUnotes{147.24mm}{%
...
% no white in the facsimile (line « sur...). » not detected)
...
% -------------------------------------------------------------------
%  leaf 93 -- folio 89: 13 lines of body, 32 of note.
%  A LINE NOT DETECTED: « S. ó, ú. », in the body. The verdict « a
%  clean double » from tools/missing_lines.py (83,1 px for a local
%  pitch of 41,4), checked under magnification: the boundary that
%  follows it carries no white.
%  The rule escaped tools/rule.py before its search window was widened
%  (§ 8 quateretvicies): it is at y = 783.
%  The block of notes OPENS on the end of note (2) of folio 88.
% -------------------------------------------------------------------
\begin{VUpage}[93]{89}
\VUnotes{72.22mm}{%
\VUcontinue
...
% no white in the facsimile (line « S. ó, ú. » not detected)
...
% -------------------------------------------------------------------
%  leaf 94 -- folio 90: 16 lines of body, 25 of note.
%  The block of notes OPENS on the continuation of note (4) of folio 89.
% -------------------------------------------------------------------
\begin{VUpage}[94]{90}
\VUnotes{89.95mm}{%
\VUcontinue
...
% -------------------------------------------------------------------
%  leaf 95 -- folio 91: 27 lines of body, 9 of note.
%  A CARDED PAGE: regular pitch 42,91 px = 10,34 pt, against 41,45 px
%  elsewhere. Twenty-seven lines only for a measure that carries
%  forty-four: the compositor spread the surplus in uniform leads.
%  Hence \VUinterlignePage.
% -------------------------------------------------------------------
\begin{VUpage}[95]{91}
...
% -------------------------------------------------------------------
%  leaf 96 -- folio 92: 30 lines of body, 7 of note.
%  The page opens on the continuation of the paragraph of folio 91.
% -------------------------------------------------------------------
\begin{VUpage}[96]{92}
\VUnotes{140.36mm}{%
...
% -------------------------------------------------------------------
%  leaf 97 -- folio 93: 5 lines of body under a TITLE, 38 of note.
%  Three faults of the detector meet on this page, and all three were
%  reported by tools/missing_lines.py before composition:
%    -- the RULE falls at 0,29 H (the page is three quarters notes):
%       it escaped tools/rule.py before its window was widened
%       (§ 8 quateretvicies). It is at y = 565.
%    -- the line « hike. » is not detected (the verdict « a clean
%       double »: 66,6 px for a local pitch of 33,0), checked under
%       magnification.
%    -- the LAST BAND carries TWO welded lines: 57 px for a median of
%       27 (§ 8 sesetvicies).
%  The true count is therefore: title + 5 lines of body + 38 of note.
%  The white under the title MEASURED on the baselines: 91,5 px for a
%  pitch of 41,4, that is an excess of 50,1 px = 4,24 mm.
%  Size and letterspacing: tools/apparatus.py 97 --regle INTERJECIONI. 1
%  --gras -> capital 29,5 px = 2,498 mm -> 10,45 pt, letterspacing -36.
% -------------------------------------------------------------------
\begin{VUpage}[97]{93}
\VUnotes{52.83mm}{%
...
% -------------------------------------------------------------------
%  leaf 98 -- folio 94: 21 lines of body (one of them a TITLE and one a
%  TABLE of five rows), 19 of note.
%  tools/missing_lines.py reported TWO double pitches here, at lines 6
%  and 7. They are the whites of the TITLE, not absent lines: a title
%  preceded by a white of 40 px gives a pitch of 82 px, which the test
%  reads as a double. That is the limit of the detection, and it is
%  why it returns two readings instead of deciding.
%  Whites of the title MEASURED on the baselines BEFORE composition:
%  82,0 px above (excess 40,2 = 3,40 mm), 89,6 px below
%  (excess 47,8 = 4,05 mm).
%  Size and letterspacing: tools/apparatus.py 98 --regle NOMBRI. 6
%  --gras -> capital 30 px = 2,54 mm -> 10,63 pt, letterspacing -81.
%  TABLE: abscissae surveyed at the cluster, margin of the block at
%  x=225 px. The leader dots fall on a regular grid of pitch 4,68 mm
%  (21,61 / 26,28 / 30,96 / 35,63 / 40,30 mm); each row carries those
%  that follow its word.
% -------------------------------------------------------------------
\begin{VUpage}[98]{94}
\VUnotes{108.54mm}{%
...
% -------------------------------------------------------------------
%  leaf 99 -- folio 95: 33 lines of body, 6 of note.
%  The page opens on the continuation of the paragraph of folio 94.
%  A LINE NOT DETECTED: « 710.) », in the body. The verdict « a clean
%  double » from tools/missing_lines.py (82,4 px for a local pitch of
%  41,5), checked against the facsimile. The boundary that follows it
%  carries no white.
%  The whites are therefore laid by hand; all are the ordinary white
%  (measured 8,7 / 8,1 / 7,9 px against 7,7 px), save those that are
%  missing.
% -------------------------------------------------------------------
\begin{VUpage}[99]{95}
\VUnotes{144.36mm}{%
...
% -------------------------------------------------------------------
%  leaf 100 -- folio 96: 25 lines of body, 17 of note.
%  The page opens on the continuation of the paragraph of folio 95.
%  One white of articulation only, before « 114. --- ».
% -------------------------------------------------------------------
\begin{VUpage}[100]{96}
\VUnotes{114.89mm}{%
...
% -------------------------------------------------------------------
%  leaf 101 -- folio 97: 29 lines of body, 9 of note.
%  The leaf is slightly askew in the scan: the surveyed abscissae slip
%  from +72 px at the top to +2 px at the foot. Only the DISTANCES
%  within one and the same region count -- the paragraph indent there
%  is 44 to 48 px everywhere, as elsewhere in the volume.
% -------------------------------------------------------------------
\begin{VUpage}[101]{97}
...
% -------------------------------------------------------------------
%  leaf 102 -- folio 98: 32 lines of body, 6 of note.
%  TWO lines not detected, both in the body: « kam 4. » and
%  « 3 foyi. ». The first was to be read in the pitch of 107,8 px
%  (« two readings » from the detection: a white of 66,3 px OR a
%  missing line + a white of 24,8), the second in a clean double of
%  83,9 px. Both checked against the facsimile.
%  Whites computed by hand, the lines restored at their pitch:
%     before « 119. » 20,5 px ; before « 120. » 25,0 px ;
%     before « Notez bone » NONE (1,1 px) ; before « 121. » 23,7 px.
% -------------------------------------------------------------------
\begin{VUpage}[102]{98}
\VUnotes{144.53mm}{%
...
% no white in the facsimile (line « 3 foyi. » not detected)
...
% -------------------------------------------------------------------
%  leaf 103 -- folio 99: 30 lines of body, 10 of note.
%  A LINE NOT DETECTED: « vespere. », in the NOTES (a clean double,
%  66,2 px for a local pitch of 32,7). Being in the notes, it shifts no
%  boundary of the body: poser_cardage stays safe.
% -------------------------------------------------------------------
\begin{VUpage}[103]{99}
\VUnotes{133.01mm}{%
...
% -------------------------------------------------------------------
%  leaf 104 -- folio 100: 26 lines of body (one of them a TITLE),
%  9 of note. The block of notes OPENS on the end of note (2) of
%  folio 99.
%  The two double pitches reported by the detection (lines 20 and 21)
%  are the whites of the TITLE, as at folio 94 -- not absent lines.
%  Measured on the baselines BEFORE composition: 124,2 px above
%  (excess 82,8 = 7,01 mm), 91,2 px below (excess 49,8 = 4,22 mm).
%  Size and letterspacing: tools/apparatus.py 104 --regle SINTAXO. 21
%  --gras -> capital 30 px = 2,54 mm -> 10,63 pt, letterspacing -44.
% -------------------------------------------------------------------
...
% -------------------------------------------------------------------
%  leaf 105 -- folio 101: 31 lines of body, 8 of note.
%  The page opens on the continuation of the paragraph of folio 100.
%  The lower margin of this leaf is spotted with foxing: 907 px of ink
%  below the last line, which used to cry out that a line was missing
%  where none was. See tools/missing_lines.py, where the criterion has
%  become the VERTICAL CONCENTRATION of that ink.
% -------------------------------------------------------------------
...
% -------------------------------------------------------------------
%  leaf 106 -- folio 102: 31 lines of body, 10 of note.
%  A LINE NOT DETECTED: « debla. », in the NOTES (a clean double,
%  66,2 px for a local pitch of 33,1) -- it ends note (2). Being in the
%  notes, it shifts no boundary of the body.
%  The right edge of the leaf is distorted by the scan: the surveyed
%  widths of lines 28 to 31 and 37-38 overrun the measure and are worth
%  nothing.
%  None of the body's four paragraph boundaries carries a white.
% -------------------------------------------------------------------
...
% -------------------------------------------------------------------
%  leaf 107 -- folio 103: 30 lines of body, 10 of note.
%  One white of articulation only, before « 128. --- ».
% -------------------------------------------------------------------
...
% -------------------------------------------------------------------
%  leaf 108 -- folio 104: 25 lines of body, 17 of note.
%  The page opens on the continuation of the paragraph of folio 103.
%  None of its paragraph boundaries carries a white.
% -------------------------------------------------------------------
...
% -------------------------------------------------------------------
%  leaf 109 -- folio 105: 31 lines of body, 8 of note.
%  The page opens on the continuation of the paragraph of folio 104,
%  and its block of notes OPENS likewise on the end of note (2) of that
%  folio.
% -------------------------------------------------------------------
...
% -------------------------------------------------------------------
%  leaf 110 -- folio 106: 28 lines of body (one of them a TITLE),
%  8 of note. A LINE NOT DETECTED: « Ido. », in the NOTES (a clean
%  double, 66,5 px for a local pitch of 32,6) -- it ends note (3).
%  The two double pitches of lines 22 and 23 are the whites of the
%  TITLE, not absent lines (the same case as at folios 94 and 100).
%  Whites of the title MEASURED on the baselines: 125,0 px above
%  (excess 83,5 = 7,07 mm), 93,7 px below (excess 52,2 = 4,42 mm).
%  Size and letterspacing: tools/apparatus.py 110 --regle
%  "TEMPI E MODI." 14 --gras -> capital 29 px -> 10,27 pt, +3.
% -------------------------------------------------------------------
...
% -------------------------------------------------------------------
%  leaf 111 -- folio 107: 31 lines of body, 8 of note.
%  The page opens on the continuation of the paragraph of folio 106.
%  The block of notes is made of six references of one line each (the
%  French equivalents) and then a note of two lines: seven paragraphs,
%  which check 12 now verifies.
% -------------------------------------------------------------------
...
% -------------------------------------------------------------------
%  leaf 112 -- folio 108: 21 lines of body, 21 of note.
%  The page opens on the continuation of the paragraph of folio 107.
%  The block of notes has only one reference, (1), but four paragraphs:
%  the last three set out the reasons, with no number.
% -------------------------------------------------------------------
...
% -------------------------------------------------------------------
%  leaf 113 -- folio 109: 32 lines of body, 6 of note.
%  The page opens on the continuation of the paragraph of folio 108.
% -------------------------------------------------------------------
...
% -------------------------------------------------------------------
%  leaf 114 -- folio 110: 39 lines of body, NO note.
%  tools/rule.py returns « rule not found », and here that is the right
%  answer: none of the page's 38 pitches falls below 38 px, so there is
%  no block of notes. The same case as at folios 71 and 75.
%  The page opens on the continuation of the paragraph of folio 109.
% -------------------------------------------------------------------
...
% -------------------------------------------------------------------
%  leaf 115 -- folio 111: 32 lines of body, 7 of note.
%  The page opens on the continuation of the paragraph of folio 110.
% -------------------------------------------------------------------
...
% -------------------------------------------------------------------
%  leaf 116 -- folio 112: 39 lines of body, NO note.
%  A CARDED PAGE: regular pitch 42,26 px = 10,18 pt.
%  A LINE NOT DETECTED: « vere? ». The detection had given it as « two
%  readings » (a white of 41,7 px OR a missing line with no white);
%  reading the facsimile decides for the second, and the ink profile
%  confirms it: baselines at 826, 868,5 and 909,5 px, two regular
%  pitches. The boundary therefore carries no white.
% -------------------------------------------------------------------
...
% no white in the facsimile (line « vere? » not detected)
...
% -------------------------------------------------------------------
%  leaf 117 -- folio 113: 39 lines of body, NO note.
%  A LINE NOT DETECTED: « testi. », in bold. The detection had given it
%  as « two readings » (a white of 73,2 px OR a missing line + a white
%  of 31,7); magnification decides for the second. The white laid is
%  therefore that of reading (b): 31,7 px = 7,64 pt.
%  The leaf carries a fold in the left margin, which makes
%  tools/weight.py unusable here -- its own limit, documented.
% -------------------------------------------------------------------
...
% -------------------------------------------------------------------
%  leaf 118 -- folio 114: 26 lines of body, 2 of note.
%  TYPOS OF THE ORIGINAL, kept: line 8, the opening quotation mark is
%  missing before « la atako di la religio »; and the quotation opened
%  by « On (line 12) is never closed.
% -------------------------------------------------------------------
\begin{VUpage}[118]{114}
% END OF THE FIRST PART: a short centred rule, laid in the white below
% the block of notes. Its ordinate is estimated on that of the same
% page's note rule, from which it stands 275 px = 23,3 mm away.
\VUornement{147.14mm}
\VUnotes{123.87mm}{%
