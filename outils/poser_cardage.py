...
outils/cardage.py mesure le pas propre a la page et les blancs de ses
...
rang ferait glisser toutes les valeurs suivantes d'un cran.
    ...
    python3 outils/poser_cardage.py 30          # propose, n'ecrit rien
    python3 outils/poser_cardage.py 30 --pose   # ecrit
"""
...
def pose(folio, ecrire=False):
    ...
    if not props:
        ...
        return
    fp = os.path.join(P, 'contenu', pg['fichier'])
    ...
    print('    pose dans contenu/%s' % pg['fichier'])
