...
graisse des verbes cites du folio 51. Voir outils/graisse.py, qui garde
...
l'epaisseur du fut de chacun (outils/graisse.py). On en tire la part des
...
On rend donc les deux parts et le detail, pour que l'oeil tranche.
    ...
    python3 outils/balayage_graisse.py          # toutes les pages
    python3 outils/balayage_graisse.py 51 54    # ces folios
"""
import os, re, sys
import numpy as np
