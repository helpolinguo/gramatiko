...
ici.
    ...
    python3 outils/arkivo.py [chemin.zip]
...
FICHIERS = ['main.tex', 'preambule.tex', 'komp.mk', 'LISEZ-MOI.md',
            '.nojekyll', 'index.html', 'gramatiko.pdf']
DOSSIERS = ['contenu', 'ornamenti', 'outils']
...
def main():
    ...
    t = subprocess.run([sys.executable, os.path.join(R, 'outils/temoins.py')],
